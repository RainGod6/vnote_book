...
![get&post请求对比](_v_images/20200704141650180_128007272.png)
...
![get请求有无sessin对比](_v_images/20200709103523191_1285501422.png)
...
- 代理的工作机制
![](_v_images/20200709143006478_1736910734.png)
...
![charles](_v_images/20200709171150824_327455554.png)
...
- charles工具代理配置
  ...
  - 设置SSL proxy
![](_v_images/20200709172128040_1692392464.png)


点击Add，添加需要监听的主机和端口地址(如果不输入，则是任意主机任意端口)
![](_v_images/20200709172524544_619237933.png)


 - 设置proxy-setting(设置监听端口)
![](_v_images/20200709173852490_826186569.png)
...
![建立代理模式](_v_images/20200709192910607_1940115482.png)


- 获取证书
![证书安装](_v_images/20200709182925163_88403681.png)

点击添加
![](_v_images/20200709183005134_1889466490.png)

查看证书状态，未被信任
![](_v_images/20200709183150376_1422609241.png)

双击证书，全部信任
![信任证书](_v_images/20200709183337367_1858071436.png)

完成证书信任
![](_v_images/20200709183415389_2046913825.png)
...
- Android证书信任问题
![](_v_images/20200710101013244_525259165.png)
...
![](_v_images/20200713205201119_875556120.png)

2.勾选enable功能
![](_v_images/20200713205357657_913759596.png)

3.输入重定向的请求及访问域名
![](_v_images/20200713205500731_901970275.png)

4.点击OK，
![](_v_images/20200713205526234_327347752.png)

5.浏览器访问baidu.com,跳转至腾讯首页
![](_v_images/20200713205655805_2028047897.png)
...
![](_v_images/20200713210641099_540559695.png)


2.勾选enable，点击add
![](_v_images/20200713210724699_1330967055.png)


3.输入网址选择本地文件
![](_v_images/20200713211215721_1373626233.png)

4.点击OK，浏览器输入baidu.com
![](_v_images/20200713211633988_911068885.png)
...
![](_v_images/20200713215338761_776347085.png)
...
![](_v_images/20200713220018565_2102302070.png)

2.添加规则
![](_v_images/20200713220206862_842446399.png)

添加修改返回值规则
![](_v_images/20200713220248144_636943322.png)



修改后结果如下：（涨幅值因为每次刷新接口返回值不固定，所以导致修改无效）
![](_v_images/20200713220554012_2047916206.png)
...
- 检查缓存
![浏览器缓存检查](_v_images/20200721152126890_912275757.png)


### 2、DNS查询

基本步骤
![](_v_images/20200721152239172_1732891966.png)
...
![](_v_images/20200721152741040_542051948.png)
...
![](_v_images/20200721153107945_641459462.png)
...
![](_v_images/20200721153919864_641269894.png)
...
浏览器内核：
![浏览器内核](_v_images/20200721154429401_1750167812.png)

不同的浏览器内核，渲染过程也不完全相同，但大致流程都差不多。

![](_v_images/20200721154638497_986903325.png)
